                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="group relative flex items-center rounded-lg border border-white/10 bg-black/40 px-4 py-3 font-mono text-sm text-gray-300">
                                    <span className="mr-3 font-bold text-green-400">POST</span>
  ...
  -d '{ "some": "data" }'`}
                    ...
                    {activeTab === 'json' && (
                        <div className="h-full">
                            ...
                            <pre className="h-[calc(100%-40px)] overflow-auto rounded-lg border border-white/10 bg-black/40 p-4 font-mono text-xs text-blue-300">
                                {result.graphJson}
                            </pre>
                        </div>
                    )}
                    ...
                    {activeTab === 'code' && (
                        <div className="h-full">
                            ...
                            <pre className="h-[calc(100%-40px)] overflow-auto rounded-lg border border-white/10 bg-black/40 p-4 font-mono text-xs text-green-300">
                                {result.code}
                            </pre>
                        </div>
                    )}
