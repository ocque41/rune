  ...
  return (
    ...
    >
      <div className="relative h-10 border-t border-white/5">
        <div className="absolute left-[25%] top-2 -translate-x-1/2 text-[10px] text-green-400 uppercase tracking-wide">True</div>
        <div className="absolute left-[75%] top-2 -translate-x-1/2 text-[10px] text-red-400 uppercase tracking-wide">False</div>
